...
int main(int argc, char *argv[])
{
  ...
  /*  {
        ...
        uint8_t code[] = { OP_PUSHI, 33, OP_POP_RES, OP_DONE };
...

    {
        ...
        uint8_t code[] = { OP_PUSHI, 1, OP_PUSHI, 5, OP_ADD, OP_POP_RES, OP_DONE };
        interpret_result result = vm_interpret(code);
        printf("vm state: %" PRIu64 "\n", vm.result);
...

    {
        ...
        uint8_t code[] = { OP_PUSHI, 10, OP_PUSHI, 9, OP_SUB, OP_POP_RES, OP_DONE };
        interpret_result result = vm_interpret(code);
        printf("vm state: %" PRIu64 "\n", vm.result);
...

    {
        ...
        uint8_t code[] = { OP_PUSHI, 30, OP_PUSHI, 0, OP_DIV, OP_POP_RES, OP_DONE };
        interpret_result result = vm_interpret(code);
        printf("vm state: %" PRIu64 "\n", vm.result);
...

    {
        ...
        uint8_t code[] = { OP_PUSHI, 10, OP_PUSHI, 4, OP_MUL, OP_POP_RES, OP_DONE };
        interpret_result result = vm_interpret(code);
        printf("vm state: %" PRIu64 "\n", vm.result);
    ...
    {
        /* Expression: 60/(2*3) */
        uint8_t code[] = { OP_PUSHI, 60, OP_PUSHI, 2, OP_PUSHI, 3, OP_MUL, OP_DIV, OP_POP_RES, OP_DONE };
        interpret_result result = vm_interpret(code);
        printf("vm state: %" PRIu64 "\n", vm.result);
